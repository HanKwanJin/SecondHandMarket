package com.han.secondhandmarket.mypage
...
import com.han.secondhandmarket.databinding.FragmentMypageBinding
                    ...
                    auth.signInWithEmailAndPassword(email,password)
                        .addOnCompleteListener(requireActivity()){ task ->
                            if(task.isSuccessful){
                                ...
                                Toast.makeText(context, "로그인에 실패했습니다. 이메일과 비밀번호를 확인해주세요.", Toast.LENGTH_SHORT).show()
                            }
                        }
                }else{
                    auth.signOut()
